const restaurantDAO = require('../DAO/restaurant.js');
...
exports.create = ({ name, address }) => {
    return restaurantDAO.create({ name, address });
};

exports.update = (id, { name, address }) => {
    return restaurantDAO.update(id, { name, address });
};

exports.remove = (id) => {
    return restaurantDAO.remove(id);
};
